...
<div class="ui-block ui-vcard ui-hcard">
	<div class="ui-hcard-wrap">
		<?php print $userIdInput; ?>
		<?php print $user['BACKGROUND']['TAG'] ?>
		<h1 class="ui-hcard-title DISPLAY_NAME">
			<div class="wrap"><?php print $user['DISPLAY_NAME']; ?></div>
		</h1>
		<?php print $user['PORTRAIT']['TAG']; ?>
		<div class="ui-hcard-description summary">
			<div class="wrap"><?php print $user['summary']; ?></div>
		</div>
	</div>
</div><!--/.ui-vcard-->
