...
$taogi_select_mode = isset($_GET['taogi_select_mode'])?$_GET['taogi_select_mode']:'single';
$get_params = http_build_query(array(
    ...
    'fldr'      => '',
	'taogi_select_mode' => $taogi_select_mode,
));

/** Disable cache (jinbonet) **/
...
<html xmlns="https://www.w3.org/1999/xhtml">
	...
	<link rel="stylesheet" href="../../../resources/css/lib-filemanager.css">
	<!--script type="text/javascript" src="js/include.min.js"></script-->
	<script type="text/javascript" src="../../../resources/script/lib-filemanager.js"></script>
    </head>
    <body>
...
elseif($_GET['type']==2) $apply = ($_GET['taogi_select_mode']=='multi'?'taogi_toggle_select':'apply_link');
    ...
    <div class="navbar-inner">
		...
		<div class="filters">
			...
			<div class="span3 half"> 
			    <?php if($upload_files){ ?>
						    <button class="tip btn upload-btn" title="<?php echo  lang_Upload_file; ?>"><i class="icon-plus"></i><i class="icon-file"></i><span>파일 업로드</span></button> 
			    <?php } ?>
			    <?php if($create_folders){ ?>
						    <button class="tip btn new-folder" title="<?php echo  lang_New_Folder?>"><i class="icon-plus"></i><i class="icon-folder-open"></i><span>폴더 생성</span></button> 
			    <?php } ?>
		...
		foreach ($files as $file_array) {
			...
			?>
			    ...
			    ?>	<figure data-name="<?php echo $file ?>" class="<?php if($file=="..") echo "back-"; ?>directory" data-type="<?php if($file!=".."){ echo "dir"; } ?>">
					...
					<img class="directory-img"  src="img/<?php echo $icon_theme; ?>/folder<?php if($file==".."){ echo "_back"; }?>.jpg?v=<?php echo time(); ?>" alt="folder" />
					</div>
				    </div>
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<div class="img-precontainer">
				    ...
				    <div class="img-container">
					    <span></span>
					    <img alt="<?php echo $filename." thumbnails";?>" class="<?php echo $show_original ? "original" : "" ?> <?php echo $is_icon_thumb ? "icon" : "" ?>" src="<?php echo $src_thumb; ?>?v=<?php echo time(); ?>">
				    </div>
				</div>
				<div class="img-precontainer-mini <?php if($is_img) echo 'original-thumb' ?>">
					...
					<span></span>
					<?php if($mini_src!=""){ ?>
					<img alt="<?php echo $filename." thumbnails";?>" class="<?php echo $show_original_mini ? "original" : "" ?> <?php echo $is_icon_thumb_mini ? "icon" : "" ?>" src="<?php echo $mini_src; ?>?v=<?php echo time(); ?>">
					<?php } ?>
				    </div>
				</div>
...
<?php if($_GET['taogi_select_mode']=='multi') { ?>
	<div id="taogi-send-selected-buttons">
		<button class="button taogi-send-selected" data-field_id="<?php echo $_GET['field_id']; ?>">선택한 파일 입력하기</button>
	</div>
<?php } ?>
