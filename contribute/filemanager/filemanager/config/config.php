...
if(!file_exists(JFE_DATA_PATH."/attach"))
	mkdir(JFE_DATA_PATH."/attach",0707);
if(!file_exists(JFE_DATA_PATH."/attach/".$root_folder))
	mkdir(JFE_DATA_PATH."/attach/".$root_folder,0707);
if(!file_exists(JFE_DATA_PATH."/attach/".$root_folder."/".$folder))
	mkdir(JFE_DATA_PATH."/attach/".$root_folder."/".$folder,0707);
if(!file_exists(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid))
	mkdir(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid,0707);
if(!file_exists(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid."/files"))
	mkdir(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid."/files",0707);
if(!file_exists(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid."/thumbs"))
	mkdir(JFE_DATA_PATH."/attach/".$root_folder."/".$folder."/".$eid."/thumbs",0707);
...
$base_url ="http://".$_SERVER['HTTP_HOST'].base_uri();  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = JFE_DATA_URI.'/attach/'.$root_folder.'/'.$folder."/".$eid.'/files/'; // path from base_url to base of upload folder (with start and final /)
$current_path = TAOGI_FILEMANAGER_ROOT.'/files/attach/'.$root_folder.'/'.$folder.'/'.$eid.'/files/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = TAOGI_FILEMANAGER_ROOT.'/files/attach/'.$root_folder.'/'.$folder.'/'.$eid.'/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language 	= "ko_KR"; //default language file name
